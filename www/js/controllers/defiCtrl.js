function defiCtrl($scope, $state) {
  ...
  if ($scope.defi1 == 3) {
     $scope.defi1 = "De te balader avec une banane entre les jambes"
  }
  if ($scope.defi1 == 4) {
     $scope.defi1 = "De crier comme un singe"
  }
  if ($scope.defi1 == 5) {
     $scope.defi1 = "D'imité un hipopotame"
  }
  if ($scope.defi1 == 6) {
     $scope.defi1 = "De t'habiller comme jérémie"
  }
  if ($scope.defi1 == 7) {
     $scope.defi1 = "De sauter pendant 10 minutes"
  }
  if ($scope.defi1 == 8) {
     $scope.defi1 = "De faire la pire des grimace"
  }
  if ($scope.defi1 == 9) {
     $scope.defi1 = "De bridé t'es yeux"
  }
  if ($scope.defi1 == 10) {
 ...
 // Defi 2
  ...
  if ($scope.defi2 == 3) {
     $scope.defi2 = "De te balader avec une banane entre les jambes"
  }
  if ($scope.defi2 == 4) {
     $scope.defi2 = "De crier comme un singe"
  }
  if ($scope.defi2 == 5) {
     $scope.defi2 = "D'imité un hipopotame"
  }
  if ($scope.defi2 == 6) {
     $scope.defi2 = "De t'habiller comme jérémie"
  }
  if ($scope.defi2 == 7) {
     $scope.defi2 = "De sauter pendant 10 minutes"
  }
  if ($scope.defi2 == 8) {
     $scope.defi2 = "De faire la pire des grimace"
  }
  if ($scope.defi2 == 9) {
     $scope.defi2 = "De bridé t'es yeux"
  }
  if ($scope.defi2 == 10) {
  ...
  if ($scope.defi3 == 2) {
     $scope.defi3 = "De te coller un post-it de servir de tableau scrum avec des post-it"
  }
  if ($scope.defi3 == 3) {
     $scope.defi3 = "De te balader avec une banane entre les jambes"
  }
  if ($scope.defi3 == 4) {
     $scope.defi3 = "De crier comme un singe"
  }
  if ($scope.defi3 == 5) {
     $scope.defi3 = "D'imité un hipopotame"
  }
  if ($scope.defi3 == 6) {
     $scope.defi3 = "De t'habiller comme jérémie"
  }
  if ($scope.defi3 == 7) {
     $scope.defi3 = "De sauter pendant 10 minutes"
  }
  if ($scope.defi3 == 8) {
     $scope.defi3 = "De faire la pire des grimace"
  }
  if ($scope.defi3 == 9) {
     $scope.defi3 = "De bridé t'es yeux"
  }
  if ($scope.defi3 == 10) {
